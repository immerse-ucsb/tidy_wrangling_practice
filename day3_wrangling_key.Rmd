...
```{r}
data(cheating) ### poLCA::cheating doesn't work here... explain!
...
ggplot(cheat_recode) +
  ...
  theme_minimal() +
  labs(x = 'GPA')
### note grades not in order! turn into a factor!
```

See `across()` for applying mutate across multiple columns simultaneously!  Also we can take advantage of indexes to assign values from a vector.
